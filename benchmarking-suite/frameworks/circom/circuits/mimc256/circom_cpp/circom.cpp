...
void MultiMIMC256_2_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MultiMIMC256_2_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 11813;}

uint get_number_of_components() {return 34;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 11713;}
...
MultiMiMC7_1_create(mySignalStart+33,0+ctx_index+1,ctx,new_cmp_name,myId);
...
MultiMIMC256_2_create(1,0,ctx,"main",0);
MultiMIMC256_2_run(0,ctx);
}
